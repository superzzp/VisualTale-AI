...
function FunWithAI() {
  ...
  var pgWelcomeFlexClassNames = displayWelcomePanel ? ["pg-welcome", "body-small"].join(" ") : ["pg-welcome", "body-small", "pg-welcome-hide"].join(" ");
      ...
      <div className="pg-root">
        ...
        <div className="pg-main">
          <div id="pg-header" className={["bottom-grey-bd"].join(" ")}>
            ...
            <div>
              <button className={["regular-button"].join(" ")} onClick={() => setDisplayWelcomePanel(true)}>
